...
import { Clock, Users, Plus, BookmarkCheck, ChefHat, Pencil, Trash2 } from 'lucide-react';
...
const MOCK_MY_RECIPES: Recipe[] = [
  {
    ...
    description: 'A rustic sourdough bread with a perfect crust and chewy interior.',
    image: 'https://images.unsplash.com/photo-1585478259715-876acc5be8eb?w=800&auto=format&fit=crop',
    cookingTime: 180,
    difficulty: 'hard',
    servings: 8,
...
const MOCK_SAVED_RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    description: 'Homemade ramen with rich broth, fresh noodles, and marinated eggs.',
...
export default function MyRecipes() {
  ...
  const [savedRecipes, setSavedRecipes] = useState<Recipe[]>(MOCK_SAVED_RECIPES);
      ...
      {currentRecipes.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">
            {activeTab === 'created' ? "You haven't created any recipes yet" : "No saved recipes"}
          </h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {currentRecipes.map(recipe => (
            <div key={recipe.id} className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200 group">
